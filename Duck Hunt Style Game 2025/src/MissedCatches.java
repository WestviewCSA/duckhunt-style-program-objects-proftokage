...
public class MissedCatches {
    ...
    public MissedCatches() { 
    	
        img = getImage("/imgs/net_2.png"); // Load the image file
    ...
    public MissedCatches(int x, int y, double scaleX, double scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public MissedCatches(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = MissedCatches.class.getResource(path);
