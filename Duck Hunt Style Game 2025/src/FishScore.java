...
public class FishScore {
    ...
    public FishScore() { 
        ...
        img = getImage("/imgs/filledfish.png"); // Load the image file
    ...
    public FishScore(int x, int y, double scaleX, double scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public FishScore(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = FishScore.class.getResource(path);
