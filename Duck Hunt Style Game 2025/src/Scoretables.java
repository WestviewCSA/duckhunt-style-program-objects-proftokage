...
public class Scoretables {
    ...
    public Scoretables() { 
        ...
        img = getImage("/imgs/Scoretables.png"); // Load the image file
    ...
    public Scoretables(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public Scoretables(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = Scoretables.class.getResource(path);
